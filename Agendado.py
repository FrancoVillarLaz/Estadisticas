...
estadistica_mensual = 'estadistica_mensual_agendado.csv'
estadistica_diaria = 'estadistica_diaria_agendado.csv'
grafico_mensual = 'estadistica_mensual_agendado.png'
grafico_diario = 'estadistica_diaria_agendado.png'
...
def cargar_datos(archivo):
    ...
    try:
        ...
        # Filtrar solo filas con tipificación "Agendado por el Vdor"
        df = df[df['Tipificación'].str.strip().str.lower() == 'agendado por el vdor']
...
def generar_graficos(df_mensual, df_diario):
    ...
    plt.title('Estadísticas Mensuales por Horario (Agendado por el Vdor)')
    plt.ylabel('Cantidad')
    plt.xlabel('Mes')
    plt.tight_layout()
    ...
    agregar_valores_inicio_por_color(ax)
    plt.title('Estadísticas Diarias por Horario (Agendado por el Vdor)')
    plt.ylabel('Cantidad')
    plt.xlabel('Fecha')
    plt.tight_layout()
